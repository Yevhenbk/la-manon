...
const ProductCardList: React.FC<ProductCardListProps> = ({
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center px-1">
      <div
        className="flex flex-col md:flex-row text-secondary w-full md:w-[80vw] 
      ...
      <div className="w-full md:w-[80vw] grid grid-cols-1 md:grid-cols-2 grid-rows-2 gap-1 md:mt-10 md:px-0">
